...
@{Key=6.2.5; Title=and Section 6.2.6 of PCI Express Base Specification). For a Multi-; Body=- Function Device, this bit controls error reporting for each function from
...
## 10.6 1G Ethernet Controller}(@{Key=6.2.5; Title=and Section 6.2.6 of PCI Express Base Specification). For a Multi-; Body=- Function Device, this bit controls error reporting for each function from
point-of-view of the respective Function. For a Root Port, the reporting of
- Non-fatal errors is internal to the root. No external ERR_NONFATAL
Message is generated.
- RW
...
1G Ethernet Controller
## 10.6 1G Ethernet Controller}.Body)
