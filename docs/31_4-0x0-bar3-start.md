...
this field are as follows: - Wire: R (sticky) - Dbi: if (BAR_ENABLED == 1) then (if [DBI_RO_WR_EN == 1] then R(Sticky)/W(Sticky) else R(Sticky)) else RO(Sticky) Note: This register field is sticky. 0x0 BAR3_MEM_IO:
- BAR3 Memory Space Indicator. This bit is used to determine whether the
...
- PCIE_X<j>_EP_PF0_TYPE0_HDR_BAR4_REG_0
where <j> = 4, 8.
...
- PCIE_X4_EP_PF0_TYPE0_HDR_BAR4_REG_0
- PCIE_X8_EP_PF0_TYPE0_HDR_BAR4_REG_0
- Offset: 0x20
- Read/Write: R/W
- Parity Protection: N
- Shadow: N
