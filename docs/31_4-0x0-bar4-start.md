...
this field are as follows: - Wire: R (sticky) - Dbi: if (BAR_ENABLED == 1) then (if [DBI_RO_WR_EN == 1] then R(Sticky)/W(Sticky) else R(Sticky)) else RO(Sticky) Note: This register field is sticky. 0x0 BAR4_MEM_IO:
- BAR4 Memory Space Indicator. This bit is used to determine whether the
...
- PCIe x4/x8 Endpoint
- PCIE_X<j>_EP_PF0_TYPE0_HDR_BAR5_REG_0
...
- PCIE_X4_EP_PF0_TYPE0_HDR_BAR5_REG_0
- PCIE_X8_EP_PF0_TYPE0_HDR_BAR5_REG_0
- Offset: 0x24
- Read/Write: R/W
- Parity Protection: N
- Shadow: N
