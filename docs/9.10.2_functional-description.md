...
@{Key=9.10.2; Title=Functional Description; Body=The following is an overview of the CoreSight based implementation for the SoC.
...
CSITE, and LA clock muxes.}(@{Key=9.10.2; Title=Functional Description; Body=The following is an overview of the CoreSight based implementation for the SoC.
